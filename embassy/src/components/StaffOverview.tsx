...
import { STAFF_ROLES, type StaffRole } from '../data/staffMeta';
    ...
    <>
      <header className="staff-page__header">
        <div>
          ...
          <p className="staff-page__subtitle">
            Manage embassy panel access for your team with granular section-level control.
          </p>
        </div>
      ...
      <section className="staff-page__stats" aria-label="Staff metrics">
        <article className="stat-card">
          ...
          <p className="stat-card__hint">All embassy panel staff</p>
        </article>
        <article className="stat-card">
