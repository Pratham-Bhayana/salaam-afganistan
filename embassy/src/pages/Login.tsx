...
export function Login() {
  ...
  const [email, setEmail] = useState(import.meta.env.VITE_EMBASSY_EMAIL || '');
  const [password, setPassword] = useState(import.meta.env.VITE_EMBASSY_PASSWORD || '');
          ...
          <form className="login-form" onSubmit={onSubmit} noValidate>
            ...
            <label className="login-form__field">
              ...
              <input
                ...
                placeholder="embassy.admin@salaam.local"
                value={email}
