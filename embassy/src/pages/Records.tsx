...
export function Records() {
  ...
  async function onExport() {
    ...
    try {
      ...
      a.href = url;
      a.download = `embassy-decision-records-${new Date().toISOString().slice(0, 10)}.csv`;
      a.click();
  ...
  return (
    <div className="applications records-page">
      ...
      <p className="records-note">Only cases decided by your embassy mission are listed here.</p>
              ...
              {!loading && rows.length === 0 ? (
                <tr>
                  <td colSpan={9} className="records-empty">
                    No embassy decisions for this filter.
                  </td>
                </tr>
              ) : null}
              {rows.map((row) => (
